...
{
    [TestFixture]
    public class RecipeViewModelToRecipeMappingTests
    {
        private RecipeViewModel _input;
        private Recipe _result;

        [TestFixtureSetUp]
        public void BeforeAll()
        {
            _input = Builder<RecipeViewModel>.CreateNew().Build();

            var mapper = new AutoMapperMapper<RecipeViewModel, Recipe>();

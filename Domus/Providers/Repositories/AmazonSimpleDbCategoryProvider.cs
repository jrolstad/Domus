...
{
    public class AmazonSimpleDbCategoryProvider : IRepository<Category, string>
    {
        ...
        internal AmazonSimpleDbCategoryProvider(SimpleDBProvider<Category, string> simpleDbProvider,ICache cache)
        {
        ...
        /// <param name="cache"> </param>
        public AmazonSimpleDbCategoryProvider(string accessKey, string secretKey,ICache cache)
        ...
        /// <returns></returns>
        public IEnumerable<Category> Find(Func<Category, bool> filterCriteria)
        {
